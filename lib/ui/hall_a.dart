...
class HallA extends StatefulWidget {
  const HallA({Key? key}) : super(key: key);

  @override
  State<HallA> createState() => _HallAState();
}

class _HallAState extends State<HallA> {
  ...
  void initState() {
    ...
    CommentsProviders productsProvider = Provider.of(context, listen: false);
    productsProvider.fetchComments();
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('Hall A'),
        // actions: [
        //   commentsProviders.getCommentsList.any((element) {
        //     return element.hall == 'Hall A';
        //   })
        //       ? Text('yes')
        //       : Text('No'),
        // ],
